...
<body>
	...
	<%
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("select item_id,item_name,item_price from productdetails");
				...
				<td>
					<form action="${pageContext.request.contextPath}/quantityprocess">
						...
						<input type="hidden" name="item_name"
							value="${item.getItem_name()}" /> <input type="hidden" size="10"
							name="item_price" value="${item.getItem_price()}" /> <input
							type="text" size="15" name="item_quantity" />
